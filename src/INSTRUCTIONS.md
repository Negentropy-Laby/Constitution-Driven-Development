...
- **Game**: use the engine-specialist agent configured in the repository root
  instructions. See Technical Preferences -> Engine Specialists -> File Extension
  Routing there. When in doubt, use the primary engine specialist.
