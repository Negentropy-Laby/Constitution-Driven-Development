...
- Skill specs: `CDD Skill Testing Framework/skills/[category]/[name].md`
- Agent specs: `CDD Skill Testing Framework/agents/[tier]/[name].md`
- Catalog: `CDD Skill Testing Framework/catalog.yaml`
- Rubric: `CDD Skill Testing Framework/quality-rubric.md`
...
language    → python-specialist, typescript-specialist, rust-specialist,
              go-specialist
...
CDD skills or agents themselves. `/skill-test` and `/skill-improve` will report that
