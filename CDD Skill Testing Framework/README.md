...
Quality assurance infrastructure for the **Constitution Driven Development** framework.
...
│   ├── language/          ← Python, TypeScript, Rust, and Go specialists
...
| `utility` | constitute, constitute-check, adopt, hotfix, localize, setup-engine, … | Passes static checks |
...
| `language` | python-specialist, typescript-specialist, rust-specialist, go-specialist |
...
```bash
rm -rf "CDD Skill Testing Framework"
```
