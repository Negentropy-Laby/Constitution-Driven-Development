...
> - `design/cdd/crafting-system.md` (what was designed)
...
> - Full UI polish, all features from CDD
...
> 2. I'll update `design/cdd/crafting-system.md` with "Alpha Scope" markers
...
> 2. Updated design/cdd/crafting-system.md with Alpha/Beta scope markers
...
> - `design/cdd/crafting-system.md` (added Alpha/Beta scope markers)
...
> > CDD has implementation guidance. Estimated 1.5 weeks to implement Alpha scope."
>
> To `producer`:
...
- Updated crafting CDD with scope markers
