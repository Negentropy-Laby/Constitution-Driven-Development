...
**Starting State:**
- `design/cdd/combat-system.md` exists and reviewed
...
**User:**
> Implement the damage calculation system from design/cdd/combat-system.md. The formula is in section 4.

## Turn 2: Agent Reads Design and Asks Clarifying Questions

**Agent (gameplay-programmer):**
> I've read `design/cdd/combat-system.md`. The damage formula is:
>
> ```
...
> design/cdd/health-system.md                  # Minimal health doc
...
> - ✅ `design/cdd/health-system.md` (minimal 8-section doc)
>
...
> git add design/cdd/health-system.md
> git add tests/combat/test_damage_calculator.gd
> git commit -m "Implement damage calculation system per design/cdd/combat-system.md"
> ```
>
