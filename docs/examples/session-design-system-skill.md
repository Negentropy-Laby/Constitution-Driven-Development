# Example Session: Using /design-system to Author a CDD

**Context:** Solo indie dev, week 3 of project. `/map-systems` already ran and produced `design/cdd/module-index.md`. The movement system is listed as MVP tier, Foundation priority.

**Starting State:**
- `design/cdd/game-concept.md` exists (survival-crafting game, 2D, Godot 4.6)
- `design/cdd/module-index.md` exists (15 systems identified, movement is first in design order)
- No per-system CDDs written yet
- No upstream dependencies for movement (it is the foundation)

**Session Duration:** ~60 minutes
**Turns:** 14
**Outcome:** Complete `design/cdd/movement-system.md` with all 8 required sections written to file, ready for `/design-review`
...
>
> - Read `design/cdd/game-concept.md` — survival-crafting, exploration-heavy, lone survivor stranded on alien planet
> - Read `design/cdd/module-index.md` — movement is **Foundation / MVP**, no upstream deps, downstream: combat, exploration, stamina
> - No prior CDD found for movement — starting fresh
>
...
>
> The CDD template has **8 required sections**. We'll go one at a time:
...
>
> Creating the file skeleton now with empty section headers — may I write `design/cdd/movement-system.md` with placeholders?

**User:**
> Yes

**Agent writes** `design/cdd/movement-system.md` with 8 empty section headers.
...
**Agent:**
> All 8 sections written to `design/cdd/movement-system.md`.
>
> **GDD Status:**
> - ✅ Overview
> - ✅ Player Fantasy
...
>
> **Recommended next step:** Run `/design-review design/cdd/movement-system.md` before moving to the next system in your queue (stamina is next in dependency order, per module-index).
>
> The review will validate completeness, internal consistency, and catch anything that needs revision before you build on this CDD.
...
- **Template population**: the CDD template's 8 sections become concrete content through dialogue, not bulk generation
