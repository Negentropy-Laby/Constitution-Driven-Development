...
**Context:** Solo indie dev, Pre-Production phase. The HUD and inventory screen are the first UI to design. The game has a player journey doc and CDDs for inventory and combat.

**Starting State:**
- `design/cdd/inventory-system.md` — complete
- `design/cdd/combat-system.md` — complete
...
> - `design/cdd/combat-system.md` — HUD needs: HP bar, stamina bar, active ability cooldowns (up to 3), damage numbers
> - `design/cdd/inventory-system.md` — HUD needs: quick slots (4 slots), active item indicator
>
...
### Turn 9: Agent Scans CDD and Player Journey

**Agent:**
> Loading context for inventory screen...
>
> From `design/cdd/inventory-system.md`:
...
> | Check | Status | Notes |
> |-------|--------|-------|
> | CDD alignment — all required elements present | ✅ | HP, stamina, quick slots, cooldowns all specced |
...
> |-------|--------|-------|
> | Player Need stated | ✅ | |
> | All CDD actions covered | ✅ | Equip, drop, inspect, split all in interaction map |
...
> 3. **ADVISORY (Inventory):** Full-inventory drop behavior is unspecified. Resolve in CDD before implementation, or document as out-of-scope.
