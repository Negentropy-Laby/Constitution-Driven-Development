...
Code exists in `src/gameplay/skills/`, but `design/cdd/` has no skill-system.md.
...
[Shows draft of design/cdd/skill-system.md]
...
**May I write this to design/cdd/skill-system.md?**
```
...
**Game-Designer:**
```
✅ Written to design/cdd/skill-system.md
