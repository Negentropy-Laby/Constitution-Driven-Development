...
contain? E.g., "game-concept.md or product-concept.md exists with all required sections complete.
module-index.md exists. All MVP CDDs are present and individually reviewed."]
...
**Fixture:** [Describe the failure state. E.g., "concept.md is missing.
No files exist in design/cdd/."]
