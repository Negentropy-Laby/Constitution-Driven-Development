---
name: cdd-status
description: "Generate a project progress dashboard from workflow-catalog.yaml. Reads current stage, required steps, artifact evidence, validation gaps, and writes production/project-roadmap.md after approval. Use when the user asks for project progress, a status dashboard, remaining blockers, or a customer-facing roadmap."
...
`May I write this to production/project-roadmap.md?`
