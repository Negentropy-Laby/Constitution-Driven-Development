...
This is the T2 execution standard layer for testing Constitution Driven
Development skills and agents. It defines reusable, cross-project test assets:
the registry, quality rubric, behavioral specs, and spec authoring templates.

Runtime evidence does not belong in this directory. Approved test runs,
coverage history, and skill improvement records belong in
...
T2 files define how CDD skills and agents should be tested. They are reusable
standards, not historical evidence.
...
`/skill-test` reads this T2 directory and, with user approval, writes results to
T3. `/skill-improve` reads this T2 directory, performs a test-fix-retest loop,
and writes approved improvement evidence to T3.
