...
- Workflow catalog: `.claude/docs/workflow-catalog.yaml`
- Gate policy: governed advisory
- Generated phase checklist: `docs/PHASE-CHECKLISTS.md`
- Generated gate artifacts: `.claude/docs/generated/gate-required-artifacts.md`
...
- Current workflow catalog checksum: [optional]
