...
- **audit**: Produces a coverage table of all skills in `skills/` and all agents
  (sourced from `skill_testing/catalog.yaml`), showing which have spec files and which do not.
...
**Fixture:**
- `skills/` contains 74 skill directories
- `skill_testing/catalog.yaml` lists the 53 agents
- `tests/skills/` contains spec files for a subset of skills

**Input:** `/skill-test audit`

**Expected behavior:**
1. Skill enumerates all skills in `skills/` and all agents from `skill_testing/catalog.yaml`
